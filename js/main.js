    ...
    e(function () {
            ...
            (function () {
                ...
                function n(e) {
                    ...
                    e.parents(".cd-headline").hasClass("clip") &&
                        e.parents(".cd-words-wrapper").animate({ width: "2px" }, s, function () {
                            var t;
                            (t = a),
                                ...
                                (function (e, a) {
                                    e.parents(".cd-headline").hasClass("clip") &&
                                        e.parents(".cd-words-wrapper").animate({ width: e.width() + 10 }, s, function () {
                                            setTimeout(function () {
                                                n(e);
                                            }, o);
                                        });
        ...
        a(
            ...
            i.imagesLoaded(function () {
                i.isotope({ itemSelector: "#portfolio .portfolio-section .single-item", masonry: { horizontalOrder: !0 } }),
                    s.on("click", function () {
